...
public class Client {
	...
	public static void main(String[] args) {
		 ...
		 * data type entered.
		 * 
		 * Burada kullanýcýnýn girdiði Operasyon tiplerini karakter bazýnda yorumlayarak
		 * istenilen çýktýnýn alýnmasýný saðlýyoruz. Kullandýðýmýz polymorphizm yöntemi
		 * ile girilen veri tipine ait olan operasyon metodu çaðrýlýyor.
		 */
