...
public class Main {
	...
	public static void main(String[] args) {
		// An instance has been created to access the methods in the CarBuilder
		// class.
		...
		// write() metodumuza parametre olarak verdigimiz AMG serisi arabamizin
		// ozelliklerini yazdirdik.
		write(carAbstract);
	...
	// The write () method, which holds a CarAbstract type parameter, was
	// written.
