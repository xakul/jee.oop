package jopRequisitionReadOperation;
...
public class Read {
	...
	public static void main(String[] args) throws IOException {
		...
		String entityURL = "JobRequisition";
	...
	/**
	 * Expand operation for the entity and we are giving the parameter for the
	 * which we want to expand entity
	 *
	...
	private static String getHTTPRequestResult(URL url, String basicToken) throws IOException {
		...
		/**
		 * Set the HTTP Request properties. "GET", as a request method,
		 * corresponds to Read operation.
		 * 
		 * HTTP Cagrisinin ozelliklerini belirlenir. "GET" kelimesi,cagri metodu
		 * olarak, ODATA'da okuma operasyonuna karsilik gelir.
		 */
		con.setRequestMethod("GET");

		/**
		 * "Accept" property defines the response format that will be received.
		 * For the service to work with JSON, we use "application/json" in our
		 * function.
		 * 
		 * "Accept" ozelligi, ne tur bir format kabul edilecegini belirler.
		 * Servisimizin JSON ile calismasini belirtmek icin, fonksiyonumuzda
		 * "application/json" parametresini kullaniriz.
		 */
